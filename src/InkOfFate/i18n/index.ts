...
const dict: Record<Locale, Record<string, string>> = {
  en: {
    ...
    booth_pitch_top: 'Show your face.',
    booth_pitch_bot: 'The old biker decides the tattoo you were always going to get.',
    ...
    processing_studying_long: "The master is reading you. Don't move.",
    ...
    result_invoice_tail: 'pay at the door',
    result_tap_to_swap: 'tap to swap',
    result_before: 'before',
    result_after: 'after',
    studio_step_face: 'Show me your face.',
    studio_step_q: 'Tell him something (or don\'t).',
    studio_change_face: 'change',
    result_read_more: 'Read the verdict',
    result_collapse: 'Hide',
    result_cta_again: 'Sit again',
    result_cta_wall: "Tonight's Marked",
    result_cta_share: 'Share',
    result_cta_share_done: 'Copied',
    result_back_to_studio: 'Back to the chair',

    wall_title: "Tonight's Marked",
    wall_sub: 'Everyone the master inked this week',
    wall_back: 'Back',
    wall_new: 'Sit in the chair',
    wall_fab: 'Sit in the chair',
    wall_tab_all: 'All clients',
    wall_tab_mine: 'Mine',
    wall_count_all: 'clients marked',
    wall_count_mine: 'on you',
  ...
  zh: {
    sign_title: 'INK OF FATE',
    sign_sub: '一刀你脸早就求着要的',
    booth_pitch_top: '把脸交给老师傅。',
    booth_pitch_bot: '他决定你这辈子注定要纹的图。',
    booth_step_in: '推门进去',
    ...
    processing_studying_long: '师傅在看你……别动。',
    ...
    result_invoice_tail: '出门结账',
    result_tap_to_swap: '点一下切换',
    result_before: '之前',
    result_after: '之后',
    studio_step_face: '把脸给我看。',
    studio_step_q: '想说啥？随便。',
    studio_change_face: '换',
    result_read_more: '看师傅怎么说',
    result_collapse: '收起',
    result_cta_again: '再坐一次',
    result_cta_wall: '今晚被刺的人',
    result_cta_share: '分享',
    result_cta_share_done: '已复制',
    result_back_to_studio: '回到椅子上',

    wall_title: '今晚被刺的人',
    wall_sub: '本周被师傅刺过的所有人',
    wall_back: '返回',
    wall_new: '坐到椅子上',
    wall_fab: '坐到椅子上',
    wall_tab_all: '所有人',
