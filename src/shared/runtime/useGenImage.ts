// Runtime square tattoo-edit generation through AlterU's provider-independent media API.
...
const TATTOO_SIZE = { width: 512, height: 512 } as const;

export interface GenImageOptions {
  /** Required English visual prompt. */
  prompt: string;
  /** Optional public HTTPS identity/source reference. */
  ref_url?: string;
}
